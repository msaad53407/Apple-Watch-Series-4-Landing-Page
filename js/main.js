...
const contactForm = document.querySelector('.contact__form'),
    formFields = Array.from(document.querySelectorAll('.form__field')),
    subscriptionNotificationModal = document.querySelector('.subscription__notification'),
    scrollButton = document.querySelector('.scroll__button'),
    headerMenuHamburger = Array.from(document.querySelectorAll('.header__menu-mobile__hamburger')),
...
contactForm.addEventListener('submit', e => {
    ...
    subscriptionNotificationModal.classList.add('subscription__notification-active');
    setTimeout(() => {
        subscriptionNotificationModal.classList.remove('subscription__notification-active');
    }, 2000)
});
